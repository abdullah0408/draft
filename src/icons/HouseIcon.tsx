...
const HouseIcon = forwardRef<HouseHandle, HouseProps>(
  (
    ...
    // Listen for parent hover (group-hover)
    useEffect(() => {
      ...
      const handleParentEnter = () => handleEnter();
      const handleParentLeave = () => handleLeave();
    ...
    return (
      <motion.div
        ref={containerRef}
        className={cn(
          "inline-flex items-center justify-center group-hover:[&>svg]:animate-house",
          className
        )}
